...
public:
	...
	bool publish(const char* topic, const char* text, bool retain);
	bool publish(const char* topic, const std::string& text, bool retain);
	bool publish(const char* topic, const unsigned char* data, unsigned int len, bool retain);
